...
private:
    ...
    void sendAircraftHello();
    void sendDeviceStatusFull();
    void sendFileReceiveResultForTask(const QString& taskId, bool success, const QString& message);
    ...
    void handleFileEnd();
    void handleInstallStart(const QByteArray& payload);
    ...
    QList<ReceivedPackage> m_receivedPackages;
    bool m_installingBatch = false;
